...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //만익 fragment_blank.xml 문서에 myTextView 라는 아이디를 가진 TextView 의 참조값이 필요하다면
        TextView a = binding.myTextView; //이렇게 참조하면 된다.
        return view;
    }
    //fragment 가 레이아웃으로 가지고 있는 뷰가 파괴될때 호출되는 메소드
    @Override
    public void onDestroy() {
        ...
        //fragment 보다 view 가 더 오래 살아남기 때문에 fagment 는 사용되지 않는데
        // view 만 메모리에 남아있는 것을 방지하는 효과
    }
}
